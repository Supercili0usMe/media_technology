...
image_spectre(H, False)

# Фильтр выделения краёв объекта (область-квадрат)
I2 = squarefilter(I, 30, True)
compare2imgs(I, I2, "Исходное изображение", "После применения фильтра", "Результаты работы фильтра с квадратной областью")
...
compare2imgs(I3, I4, "Пространственный ФВЧ", "Фильтр Собеля", "Сравнение двух разных фильтров")

I5 = presetfilters(I, "Canny")
compare2imgs(I3, I5, "Пространственный ФВЧ", "Фильтр Кенни", "Сравнение двух разных фильтров")
compare2imgs(I4, I5, "Фильтр Собеля", "Фильтр Кенни", "Сравнение двух разных фильтров")
